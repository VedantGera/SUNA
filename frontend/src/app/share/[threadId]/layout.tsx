...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | ApnaAI Suna',
    description: 'Replay this Agent conversation on ApnaAI Suna',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | ApnaAI Suna';
    const description =
      projectData.description ||
      'Replay this Agent conversation on ApnaAI Suna';
