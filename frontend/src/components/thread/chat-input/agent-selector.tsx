...
import { ApnaaiLogo } from '@/components/sidebar/apnaai-logo';
  ...
  const getAgentDisplay = () => {
    ...
    if (selectedAgent) {
      ...
      return {
        ...
        icon: isSelectedAgentSuna ? <ApnaaiLogo size={16} /> : selectedAgent.icon
      };
    }
    ...
    return {
      ...
      icon: isDefaultAgentSuna ? <ApnaaiLogo size={16} /> : (defaultAgent?.icon || <ApnaaiLogo size={16} />)
    };
  };
